...
$s = " select * from zamowienia where konto = '$konto' ";
...
echo "<body>";
	   ...
	   echo "<main>";
		  ...
		  echo " <section class=\"services\">";
		   echo"<p style=\"color: red; text-align: center; margin-top: 30px; Font-size: 40px;\">Dla tego konta zostało już złożone zamówienie.</p>";
		   echo "<form action=\"zamawianie.php\" method=\"post\">";
		         echo "<label class=\"container checkmarks\">";
                    echo "<input type=\"radio\" checked=\"checked\" name=\"opcja\" value=\"standard\">";
                    echo "<span class=\"checkmark\"></span>";
		            echo "<article class=\"option\">";
		            echo " <div>";
		            echo " <img style=\"margin: 0px 60px 0px 40px;\" src=\"img/card.png\" width=\"130\" height=\"130\"></img>";
		            echo " </div>";
		             echo "<div>";
		             echo "<h1>Karnet standardowy</h1> <br />";
		             echo "<p>Dostęp do stref: maszyny, wolne ciężary</p><br />";
		             echo "<br />";
		             echo "<p></p> <br />";
					 echo "<i>Cena: 79zł</i>";
		            echo "</article>";
                 echo "</label>";
                 echo "<label class=\"container checkmarks\">";
                    echo "<input type=\"radio\" name=\"opcja\" value=\"extra\">";
                    echo "<span class=\"checkmark\"></span>";
		            echo "<article class=\"option\">";
		             echo " <div>";
		               echo " <img style=\"margin: 0px 60px 0px 40px;\" src=\"img/card1.png\" width=\"130\" height=\"130\"></img>";
		             echo " </div>";
		              echo "<div>";
		              echo "  <h1>Karnet extra</h1> <br />";
		                echo "<p>Dostęp do stref: maszyny, wolne ciężary, squash</p>";
		                echo "<p>Darmowe uczestnictwo w wybranych zajęciach grupowych 2 razy w miesiącu</p> <br />";
		                echo "<p></p> <br />";
						echo "<i>Cena: 109zł</i>";
		             echo "</article>";
                echo " </label>";
                  echo "  <label class=\"container checkmarks\">";
                   echo " <input type=\"radio\" name=\"opcja\" value=\"pro\">";
                   echo " <span class=\"checkmark\"></span>";
		            echo "<article class=\"option\" style=\"margin-bottom: 20px;\">       " ;                                                                                                                          
		            echo "   <div>  " ;                                                                                                            
		             echo "     <img style=\"margin: 0px 60px 0px 40px;\" src=\"img/card2.png\" width=\"130\" height=\"130\"></img> "; 
		            echo "   </div> ";                                                                                                                                                           
		             echo "  <div> " ;                                                                                                                                                              
		              echo "      <h1>Karnet pro</h1> <br />      ";                                                                                                              
		                 echo "   <p>Dostęp do stref: maszyny, wolne ciężary, squash</p> ";                                                               
		                 echo "   <p>Darmowe uczestnictwo w wybranych zajęciach grupowych 8 razy w miesiącu</p> <br />" ;                   
		               echo "     <p></p> <br />";
                        echo "    <i>Cena: 139zł</i>	";				
		         echo "   </article>";
                  echo "  </label> <br /> <br />";
				 ...
				 echo "  <div id=\"buy\">";
			      echo " <h1>Podaj konto, na które chcesz zamówić karnet</h1>";
...
{
	$dodaj = " insert into zamowienia(opcja, konto) values ('$karnet', '$konto')";
...
echo "<body>";
	   ...
	   echo "<main>";
		   ...
		   echo "<section class=\"main-content\">";
		  echo " <section class=\"services\">";
		   echo"<p style=\"color: #2ecc71; text-align: center; margin-top: 30px; Font-size: 40px;\">Złożono zamówienie! Czas realizacji: 1-2 dni.</p>";
		   echo "<form action=\"zamawianie.php\" method=\"post\">";
		         echo "<label class=\"container checkmarks\">";
                    echo "<input type=\"radio\" checked=\"checked\" name=\"opcja\" value=\"standard\">";
                    echo "<span class=\"checkmark\"></span>";
